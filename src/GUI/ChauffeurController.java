...
public class ChauffeurController implements Initializable {
    ...
    private void ajouterChauffeur(ActionEvent event) {
         if (tfNom.getText().isEmpty()||tfCin.getText().isEmpty()||tfTel.getText().isEmpty()||tfEmail.getText().isEmpty()||tfBan.getText().isEmpty()){
        ...
        Chauffeur c = new Chauffeur(nom_chauffeur,prenom_chauffeur,cin_chauffeur,Integer.parseInt(num_tel_chauffeur),email_chauffeur,num_compte_bancaire);
